...
public enum BlockType {
	...
	BEDROCK(1, 1), COAL_ORE(2, 2), DIAMOND_ORE(2, 3), DIRT(2, 0), EMPTY(4, 11), GOLD_ORE(0, 2), GRAVEL(3, 1), GRASS(3, 0), IRON_ORE(1, 2), REDSTONE_ORE(3, 3), SAND(2, 1), SANDSTONE(0, 11), STONE(1, 0), UNDEFINED(14, 1), WOOD(4, 1);
